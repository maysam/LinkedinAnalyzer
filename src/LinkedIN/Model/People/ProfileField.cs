...
namespace LinkedIN.Model.People
{
	...
	public class ProfileField : FieldSelector
	{
        ...
        /// <summary>
        /// the member's number of connections.
        /// </summary>
        public static readonly ProfileField NumberOfConnections = new ProfileField("num-connections");
		#endregion
		#region Aggregates
		/// <summary>
		...
		/// </summary>
		public static readonly ProfileField[] All = new[] { Id, FirstName, LastName, MaidenName, NumberOfConnections };
		#endregion
	}
}